    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2 class="text-center bg-warning"><i class="halflings-icon edit"></i><span class="break text-danger  mb-2"></span>Edit  sub Category</h2>
                ...
                <form class="form-horizontal" action="{{route('subCategory.update',['id'=>$subCategory->id])}}" method="post" >
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-xlarge form-control" name="name" value="{{$subCategory->name}}">
                            </div>
                        </div>
